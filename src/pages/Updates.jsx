...
const Updates = () => {
    ...
    return (
        <div className="w-full min-h-screen pt-32 pb-20 px-6 max-w-4xl mx-auto relative bg-background overflow-hidden">
            {/* Background elements */}
            ...
            >
                <span className="text-brand-highlight tracking-widest uppercase text-sm font-bold mb-4 block">Global Intelligence</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10 w-full max-w-6xl mx-auto">
                {loading ? (
                    ...
                    news.map((item, idx) => (
                        <motion.div
                            ...
                            className="glass-panel flex flex-col h-full rounded-3xl p-8 md:p-10 shadow-[0_4px_20px_rgba(0,0,0,0.4)] hover:shadow-[0_20px_40px_rgba(0,0,0,0.6)] hover:shadow-neon-brand border border-white/5 transition-all cursor-pointer group"
                        >
                            {item.imageUrl && (
                                <div className="w-full h-56 mb-6 rounded-2xl overflow-hidden shrink-0 border border-white/5">
