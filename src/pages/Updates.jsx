...
import { FiClock, FiFileText, FiChevronDown } from 'react-icons/fi';
                    ...
                    news.map((item, idx) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                >
                                    <p className="text-muted-foreground text-lg font-medium leading-relaxed">{item.summary}</p>
                                    {!isExpanded && (
                                ...
                                <div className={`mt-8 flex items-center gap-2 text-brand-secondary text-sm font-semibold transition-all duration-300 shrink-0 ${isExpanded ? 'opacity-100' : 'opacity-0 group-hover:opacity-100 group-hover:translate-x-2'}`}>
                                    <FiFileText /> {isExpanded ? 'Collapse Report' : 'Access Full Report'}
